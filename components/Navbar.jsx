...
const Navbar = () => {
    ...
    //Enable Profile Menu Dropdown.
    const [isProfileMenuOpen, setIsProfileMenuOpen] = useState(false);

    // States that holds the providers.
            ...
            <nav className="bg-blue-700 border-b border-blue-500">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
                        ...
                        className={isMobileMenuOpen ? 'bg-gray-700 rounded-md p-2 focus:ring-2 focus:ring-inset ring-white text-white ' : 'relative inline-flex items-center justify-center  text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none '}
